...
namespace Tantalus.Migrations
{
    ...
    [Migration("20220607215603_AddExtraUserColumns")]
    partial class AddExtraUserColumns
    {
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "access", new[] { "private", "shared", "editable" });
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "sex", new[] { "unspecified", "male", "female" });
            ...
            modelBuilder.Entity("Tantalus.Entities.Food", b =>
                {
                    ...
                    b.Property<Access>("Access")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("access")
                        .HasDefaultValue(Access.Private)
            ...
            modelBuilder.Entity("Tantalus.Entities.Recipe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Tantalus.Entities.RecipeIngredient", b =>
                {
                    ...
                    b.HasIndex("FoodId")
                        .HasDatabaseName("ix_recipe_ingredients_food_id");
            ...
            modelBuilder.Entity("Tantalus.Entities.User", b =>
                {
                    ...
                    b.Property<Sex>("Sex")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("sex")
                        .HasDefaultValue(Sex.Unspecified)
                        .HasColumnName("sex");

                    b.Property<int?>("StepLength")
                        .HasColumnType("integer")
                        .HasColumnName("step_length");
            ...
            modelBuilder.Entity("Tantalus.Entities.WeightMeasurement", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");
                    ...
                    b.HasKey("UserId", "MeasuredOn")
                        .HasName("pk_weight_measurements");

                    b.ToTable("weight_measurements", (string)null);
                });
            ...
            modelBuilder.Entity("Tantalus.Entities.RecipeIngredient", b =>
                {
                    b.HasOne("Tantalus.Entities.Food", "Food")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_recipe_ingredients_foods_food_id");

                    b.HasOne("Tantalus.Entities.Recipe", "Recipe")
                        .WithMany("Ingredients")
            ...
            modelBuilder.Entity("Tantalus.Entities.WeightMeasurement", b =>
                {
                    b.HasOne("Tantalus.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_weight_measurements_users_user_id");
