...
namespace Tantalus.Migrations
{
    ...
    [Migration("20220513090635_AddWeightMeasurement")]
    partial class AddWeightMeasurement
    {
            ...
            modelBuilder.Entity("Tantalus.Entities.WeightMeasurement", b =>
                {
                    ...
                    b.HasKey("UserId", "MeasuredOn")
                        .HasName("pk_weight_measurement");

                    b.ToTable("weight_measurement", (string)null);
                });
            ...
            modelBuilder.Entity("Tantalus.Entities.WeightMeasurement", b =>
                {
                    b.HasOne("Tantalus.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_weight_measurement_users_user_id");
